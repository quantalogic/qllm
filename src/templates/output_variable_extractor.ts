...
export class OutputVariableExtractor {
  ...
  private extractVariable(key: string, variable: OutputVariable, output: string): string | null {
  ...
  private validateAndTransform(key: string, variable: OutputVariable, value: string | null): any {
    ...
    switch (variable.type) {
      ...
      default:
        ErrorManager.throwError('OutputValidationError', `Invalid type for output variable ${key}: ${variable.type}`);
    }
  }
